											...
											<TBODY>
												...
												<c:forEach items="${list }" var="linkman">
													<TR
														...
														<TD><a
															href="${pageContext.request.contextPath }/ModifyLinkmanServlet?lkm_id=${linkman.lkm_id}">修改</a>
															&nbsp;&nbsp; <a
															href="${pageContext.request.contextPath }/DeleteLinkmanServlet?lkm_id=${linkman.lkm_id}">删除</a>
														</TD>
													</TR>
