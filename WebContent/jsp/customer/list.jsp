											...
											<TBODY>
												...
												<c:forEach items="${list }" var="customer">
													<TR
														...
														<TD><a
															href="${pageContext.request.contextPath }/ModifyCustomerServlet?cust_id=${customer.cust_id}">修改</a>
															&nbsp;&nbsp; <a
															href="${pageContext.request.contextPath }/DeleteCustomerServlet?cust_id=${customer.cust_id}">删除</a>
														</TD>
													</TR>
